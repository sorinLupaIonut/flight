...
contract FlightSuretyApp {
    ...
    uint256 constant airlineRegistrationConstant = 4;
        ...
        returns (bool success, uint256 votes)
    {
        ...
        require(
            flightSuretyData.isAirlineActivated(msg.sender),
            "Your airline is not activated"
        );
        require(
        ...
        require(
            !flightSuretyData.isAirlineVoted(newAirline, msg.sender),
        ...
        address[] memory airlineVotes = flightSuretyData.getAirlineVotes(
            newAirline
        );
    ...
    function activateAirline(address airlineAddress) external payable {
        ...
        require(
            !flightSuretyData.isAirlineActivated(airlineAddress),
            "This airline is already activated"
        );
        require(
            msg.value == 10 ether,
            "Please submit 10 ether to activate your airline"
        );
     ...
     *
     */
    function isAirlineActivated(address airlineAddress)
        external
        view
        returns (bool)
    {
    ...
    function buyInsurance(
        ...
        require(
            msg.value <= 1 ether,
            "Amount should be less than or equal to 1 ether"
        );
    ...
    function claimInsuranceAmount(
        ...
        require(isOperational(), "Service is not available");
        flightSuretyData.claimInsuranceAmount(
            airline,
            flight,
            timestamp,
            airline,
    ...
    function fetchFlightStatus(
        ...
        require(
            flightSuretyData.isAirlineActivated(airline),
            "This airline is not activated"
        );
